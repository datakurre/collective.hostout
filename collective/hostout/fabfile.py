...
from collective.hostout.hostout import asbuildoutuser, HostoutTask
...
def deploy():
    ...
    api.execute(predeploy)
    api.execute(predeploy)
    api.execute(uploadeggs)
    api.execute(uploadbuildout)
    api.execute(buildout)
    api.execute(postdeploy)
